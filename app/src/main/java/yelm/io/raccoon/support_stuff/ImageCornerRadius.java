...
public class ImageCornerRadius extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public ImageCornerRadius(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ImageCornerRadius);
        cornerRadius = a.getDimensionPixelSize(R.styleable.ImageCornerRadius_cornerRadius, 0);
        roundedCorners = a.getInt(R.styleable.ImageCornerRadius_roundedCorners, CORNER_NONE);
        a.recycle();
    }
