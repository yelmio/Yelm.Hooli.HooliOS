...
public class ItemFromNotificationActivity extends AppCompatActivity  implements AppBarLayout.OnOffsetChangedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (args != null) {
            Log.d(Logging.debug, "ItemFromNotificationActivity - id: " + args.getString("id"));
        ...
        RetrofitClient.
                ...
                enqueue(new Callback<Item>() {
                    ...
                    public void onResponse(@NotNull Call<Item> call, @NotNull final Response<Item> response) {
                        if (response.isSuccessful()) {
                            if (response.body() != null) {
                                ...
                                Log.e(Logging.error, "Method getItemById() - by some reason response is null!");
                            }
                        } else {
                            Log.e(Logging.error, "Method getItemById() - response is not successful." +
                    ...
                    public void onFailure(@NotNull Call<Item> call, @NotNull Throwable t) {
                        Log.e(Logging.error, "Method getItemById() - failure: " + t.toString());
                    }
                });
